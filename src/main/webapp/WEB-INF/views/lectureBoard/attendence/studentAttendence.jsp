						...
						<div class="informDetailTop">
							<table class="mb-3" border="1">
								...
								<tr>
									<td>학번</td>
									<td class="W">
										<input type="text" id="stuNo" name="stuNo" class="form-control f9" disabled  />
									</td>
									<td>이름</td>
									<td class="W">
										<input type="text" id="stuNm" class="form-control f9" disabled/>
									</td>
									<td>출석</td>
									<td class="W">
										<input type="text" id="atenAttend" class="form-control f9" disabled />
									</td>
									<td>지각</td>
									<td class="W">
									...
									<td>조퇴</td>
									<td class="W">
										<input type="text" id="atenEarly" class="form-control f9" disabled/>
									</td>
									<td>공결</td>
									<td class="W">
										<input type="text" id="atenOffically" class="form-control f9" disabled />
									</td>
								</tr>
							</table>
						</div>
