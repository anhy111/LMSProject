...
<form action="/lectureBoard/data/dataUpdate" method="post" enctype="multipart/form-data">
<div class="row">
				...
				<div class="card-header" style="padding-bottom:0px">
						<div class="row form-group">
							<div class="col-sm-8">
								...
								<input type="hidden" id="ldtCd" name="ldtCd" value="${lecData.ldtCd}">
								<input type="hidden" id="lecaCd" name="lecaCd"value="${lecData.lecaCd}">
							</div>
							
							<div class="col-sm-4" style="text-align:right;">
								<br>
								<b class="col taskData" name="ldtWriter">작성자 : ${lecData.ldtWriter}</b>&nbsp; | &nbsp; <b> 등록일 : <fmt:formatDate value="${lecData.ldtReg}" pattern="yyyy-MM-dd"/> </b>
								<input type="hidden" name="ldtWriter" value="${lecData.ldtWriter}">
							</div>
				...
				<div class="row">
					...
					<div class="taskData col-sm-5" align="right" >
						<sec:authorize access="hasRole('ROLE_PROFESSOR')">
							<button  type="button" class="btn btn-danger" id="DeleteButton" onclick="fn_del()">삭제</button>
							<button  type="button" class="btn btn-info" id="ModifyButton">수정</button>
						</sec:authorize>
						<a href="/lectureBoard/data/lectureData?lecaCd=${lecData.lecaCd}"  class="btn btn-primary">목록</a>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-10">
