...
<aside class="main-sidebar sidebar-light-primary elevation-4" style="background-color:#112a63;">
    <!-- Brand Logo -->
...
<!-- 							<i class="far fa-circle nav-icon"></i> -->
					...
					<li class="nav-item"><a href="/counsel/studentside/applyList?stuNo=<%= no %>" class="nav-link">
<!-- 					<i class="nav-icon far fa-envelope"></i> -->
							<p>상담</p>
					</a></li>
					<li class="nav-item"><a href="/lectureBoard/test/studentTest?lecaCd=1" class="nav-link"> 
<!-- 					<i class="nav-icon far fa-envelope"></i> -->
...
<!-- 						<i class="nav-icon fas fa-book"></i> -->
						...
						<ul class="nav nav-treeview">
							<li class="nav-item"><a href="/lecture/list" class="nav-link"> 
<!-- 							<i class="far fa-circle nav-icon"></i> -->
									<p>전체 강의 조회</p>
							</a></li>
...
<!-- 							<i class="far fa-circle nav-icon"></i> -->
							...
							<li class="nav-item"><a href="/professor/lecApply/request" class="nav-link"> 
<!-- 							<i class="far fa-circle nav-icon"></i> -->
									<p>강의계획서 신청</p>
							</a></li>
							<li class="nav-item"><a href="/lecture/myLecture" class="nav-link"> 
<!-- 							<i class="far fa-circle nav-icon"></i> -->
									<p>담당 강의 조회</p>
							</a></li>
						</ul></li>
...
<!-- 							<i class="far fa-circle nav-icon"></i> -->
					...
					<li class="nav-item"><a href="/counsel/professorside/counselList" class="nav-link"> 
<!-- 					<i class="nav-icon fas fa-book"></i> -->
							<p>상담</p>
					</a></li>
				</sec:authorize>
...
<!-- 									<i class="far fa-circle nav-icon"></i> -->
					...
					<li class="nav-item"><a href="/ketIndicators/chart" class="nav-link">
<!-- 					 <i class="nav-icon fas fa-book"></i> -->
							<p>중점 지표</p>
					</a></li>
				</sec:authorize>
